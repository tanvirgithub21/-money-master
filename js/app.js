...
const switchTab = (id) => {
    if (id === "posts") {
        ...
        document.getElementById( "liked" ).innerHTML = "";//==================== Solved >>
...
const createPost = (post) => {
    ...
    const userImage = post.userImage;   //==================== Solved >>
    const userName = post.comments[0].user;   //==================== Solved >>
    const userText = post.comments[0].text;   //==================== Solved >>
